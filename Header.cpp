...
string name;
PeaPuff peaPuff = PeaPuff();
FigurePuff figPuff = FigurePuff();
...
void Introduction1() {
    ...
    PuffPrint("A worker came up to you and askes, What is your name? ");
    cin >> name;
    cout << "**Welcome," << name << "! How can we help you today!?\n";
...
void Introduction2() {
    ...
    int puffPrice1 = peaPuff.getCost();
    int  puffPrice2 = figPuff.getCost();
